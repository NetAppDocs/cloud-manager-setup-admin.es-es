...
summary: 'Descubra las novedades de las funciones de administración de BlueXP (antes Cloud Manager): Cuentas de NetApp, conectores, credenciales de proveedores de cloud, etc.' 
---
= Lo nuevo
:hardbreaks:
:allow-uri-read: 
